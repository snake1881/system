<template>
  <div class="dept">
    ...
    >
      ...
      <el-table-column prop="sequence" label="排序" width="60" />
      <el-table-column prop="departmentType" label="部门类型" max-width="120">
        <template slot-scope="scope">
          <p v-if="scope.row.departmentType == '0'">内部单位</p>
          <p v-if="scope.row.departmentType == '1'">管理机构</p>
        </template>
      </el-table-column>
      <el-table-column prop="createTime" label="创建时间" max-width="240" />
