  ...
  <div class="system">
    <el-form :model="abnormalGtFrom" height="40px" :inline="true">
      <el-form-item label="采油站">
        <el-select v-model="abnormalGtFrom.orgName" placeholder="全区" size="medium">
          <el-option
            v-for="item in abnormalGtDate"
            :key="item.orgName"
            :label="item.orgName"
            :value="item.orgName"
          ></el-option>
    ...
    >
      ...
      <el-table-column prop="checkDate" label="日期" width="280" />
