<template>
  <div class="standard">
    ...
    <div class="standard_echarts">
      ...
      >
        <div
          class="standard_echarts_child"
          :key="item.dynaId"
          :id="item.dynaId"
        ></div>
        <div class="standard_echarts_button">
          <el-button type="primary" size="mini" @click="deleteStandard(item)"
            >删除</el-button
          >
        </div>
      </div>
...
@import "../../../assets/css/diagnosis/knowledge/standard.css";
</style>
