<template>
  <el-dialog
    :title="cadenceData.wellId + '井 井下作业终止'"
    :visible.sync="cadenceOperVisible"
    width="43%"
    :before-close="cadenceOperClose"
  >
    ...
    <el-button
      type="primary"
      @click="saveCaCdenceOper(), cadenceOperClose()"
      class="caCdenceOperButton"
      >终止</el-button
    >
