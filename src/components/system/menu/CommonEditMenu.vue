<template>
  <el-dialog title="菜单编辑" :visible.sync="editMenuVisible" width="40%" :before-close="editMenuClose">
    ...
    <el-button type="primary" @click="saveEditMenu(), editMenuClose()" class="editMenuButton">提交</el-button>
