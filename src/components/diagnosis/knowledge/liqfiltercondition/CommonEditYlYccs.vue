...
export default {
  ...
  methods: {
    ...
    // 保存修改后的信息
    saveEditYlYccs() {
      this.putRequest("/knowledge/ylYcss/ylYcss", this.editData).then(resp => {
        if (resp) {
          this.$message({
