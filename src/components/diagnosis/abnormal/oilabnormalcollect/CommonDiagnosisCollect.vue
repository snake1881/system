  ...
  <template>
    <div class="dialogDiv">
      <div class="waterAbnormal_top">
        <el-form style="height:42px;" :model="diagndosisData" :inline="true">
          <el-form-item label="采油站">
            <el-select
              size="medium"
              v-model="diagndosisData.oilStationId"
              style="width: 150px"
              filterable
              clearable
              placeholder="全区"
          ...
          <el-form-item label="日期">
            <el-date-picker
              size="medium"
              v-model="diagndosisData.createTime"
              style="width: 150px"
              type="date"
              placeholder="选择日期"
              format="yyyy-MM-dd"
          ...
          <el-form-item label="异常条件">
            <el-select
              ...
              filterable
              clearable
              v-model="diagndosisData.abnormalType"
              placeholder="请选择"
            >
              <el-option
