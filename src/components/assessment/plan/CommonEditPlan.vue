<template>
<el-dialog title="编辑考核计划" :visible.sync="editPlanVisible" width="59%" :before-close="editPlanClose">
  <div class="editPlan">
    <el-form :model="editData" label-width="80px">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="开始时间">
            <el-date-picker type="datetime" v-model="editData.startDate" value-format="yyyy-MM-dd hh:mm:ss" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="结束时间">
            <el-date-picker type="datetime" v-model="editData.endDate" value-format="yyyy-MM-dd hh:mm:ss" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <div class="editPlanDec">
        <el-form-item v-for="(item, index) in editData.resultInforList" :key="index">
          <el-row>
            <el-col :span="8">
    ...
    <el-button type="primary" @click="saveAddPlan(), editPlanClose()" class="editPlanButton"> 提交 </el-button>
